        ...
        async function deleteProdCart(btns){
            btns.forEach(deletebtn => {
                deletebtn.addEventListener('click', function(){
                    const cartid = deletebtn.id;

                    fetch('http://localhost/minicell/index.php/removetocart',{
                        method: 'POST',
                        headers:{
                            'content-type': 'application/json'
                        },
                        ...
                        .then(res => res.json())
                        .then(data => {
                            window.location.href = '/minicell/index.php/cart';
                        })
                })
            })
        }
        async function modifyQty(btns){
            btns.forEach(qtyfield => {
                console.log(qtyfield)
                qtyfield.addEventListener('change', function(){
                    fetch('http://localhost/minicell/index.php/updatecart',{
                        method: 'POST',
                        headers:{
                            'content-type': 'application/json'
                        },
