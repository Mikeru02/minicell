...
<html lang="en">
            ...
            <main id="main">
                ...
                <section id="product-page" class="product-page">
                    ...
                    <div class='navigation'>
                        <form action="/minicell/index.php/homepage" method='GET' id="form">
    ...
    <script>
        ...
        const body = document.querySelector('.responsive-container')
        ...
        document.addEventListener('DOMContentLoaded', function(){
            ...
            if (category && prod.length === 0) {
                result = []; // No products found for this category
            } else if (category) {
                result = prod; // Show the filtered products for the selected category
            } else {
                result = prods; // No category specified, show all products
            }
        ...
        function updateDisplayArea(products) {
